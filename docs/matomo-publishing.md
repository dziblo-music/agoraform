...
An empty, JSON `null`, or otherwise unrecognizable publish response is not
treated as success. The publish request has already been sent, so Agoraform
cannot know whether Matomo completed publication. The resulting error says
