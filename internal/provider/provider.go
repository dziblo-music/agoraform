...
// are used by apply. Optional Destroyer support is used by destroy. Import
// reads an existing remote identity and must not create, update, or delete
// remote resources. Plan must only call Name, ResourceTypes, Validate, and
// Read.
